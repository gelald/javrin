import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,e as s}from"./app-f9042815.js";const l={},d=s(`<h1 id="rocketmq-broker-配置详解" tabindex="-1"><a class="header-anchor" href="#rocketmq-broker-配置详解" aria-hidden="true">#</a> RocketMQ Broker 配置详解</h1><p>这里记录了Broker配置文件各种配置及其注释，记录起来方便使用时参考。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># Licensed to the Apache Software Foundation (ASF) under one or more
