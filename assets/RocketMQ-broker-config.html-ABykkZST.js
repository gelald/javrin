import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as s,o as a,a as e}from"./app-ztW5o0ZG.js";const i={},l=e(`<h1 id="rocketmq-broker-配置详解" tabindex="-1"><a class="header-anchor" href="#rocketmq-broker-配置详解"><span>RocketMQ Broker 配置详解</span></a></h1><p>这里记录了Broker配置文件各种配置及其注释，记录起来方便使用时参考。</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span># Licensed to the Apache Software Foundation (ASF) under one or more</span></span>
